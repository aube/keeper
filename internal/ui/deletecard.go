...
type DeletecardScreen struct {
	width    int
	height   int
	api      DeletecardScreenAPI
	inputs   []textinput.Model
	focus    int
	errorMsg string
}

func NewDeletecardScreen(api DeletecardScreenAPI) DeletecardScreen {
	a := DeletecardScreen{
		api:    api,
...
func (a DeletecardScreen) Init() tea.Cmd {
	return textinput.Blink
}

func (a DeletecardScreen) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	var cmds []tea.Cmd
...
func (a DeletecardScreen) View() string {
	title := "Авторизация"
...
func (a *DeletecardScreen) SetSize(width, height int) {
	a.width = width
	a.height = height
}
